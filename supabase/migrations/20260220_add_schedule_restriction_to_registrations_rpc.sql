-- Migration: Add schedule_restriction to user registrations RPC functions
...
-- Recreate get_user_registrations with schedule_restriction
...
-- Recreate get_user_registrations_in_tournament with schedule_restriction
